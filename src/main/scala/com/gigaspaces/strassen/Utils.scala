...
object Utils {
  ...
  def splitMatrixToQuadrants(matrix: Matrix): Array[BlockMatrix] = {
    ...
    def strassenMultiply(matA: Matrix, matB: Matrix): Matrix = {
      ...
      // M6 = (A21 − A11)*(B11 + B12)
      val M6 = A11.subtract(A21).multiply(B11.add(B12))
      // M7 = (A12 − A22)*(B21 + B22)
